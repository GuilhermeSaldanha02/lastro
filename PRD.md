...
> **EMENDA em 2026-09-25 — o lastro abre para o público. Decisão do dono.** A frase "o dono" acima descreve a persona de DESENHO e continua sendo ela: quem treina sozinho, no celular, entre séries, com sinal ruim. O que muda é quem pode CRIAR CONTA: qualquer pessoa, sem convite. Isso reabre o §5 ("onboarding para estranhos", "limite de uso") nos termos da emenda registrada lá. **O veto a decidir por "outros usuários poderiam querer" continua valendo**: abrir a porta não autoriza feature especulativa. Cada item da abertura (PU-02 a PU-10, `docs/BACKLOG-CANONICO.md`) existe porque um estranho não tem o dono por perto para consertar o que quebra, não porque um estranho "poderia querer" algo. Registro: `DECISIONS.md` 2026-09-25 (1).
...
- ❌ Múltiplos usuários, planos pagos, onboarding para estranhos, tela de billing, limite de uso. → **PARCIALMENTE REVISTO em 2026-09-03 pelo §11; "onboarding para estranhos" e "limite de uso" REVISTOS em 2026-09-25 (emenda logo abaixo).** O vínculo aluno↔personal reabre "múltiplos usuários" de forma restrita (convite aceito, 1:1, revogável). **Planos pagos, tela de billing e limite de uso continuam fora** — a monetização é motivação declarada do §11, não escopo aprovado, e entra por Scope Change próprio quando for a hora.
- **EMENDA em 2026-09-25 (Scope Change — abertura ao público, decisão do dono).** A linha anterior sobre "onboarding para estranhos" e "limite de uso" **deixa de valer**. Ver `DECISIONS.md` 2026-09-25 (1). O que entra e o que continua fora:
  - ✅ **Entra:** cadastro aberto a qualquer pessoa; **limite de uso de IA por conta** (a cota da Gemini e o custo são do dono — sem teto por conta, cada conta nova é gasto sem limite); recuperação de senha; Termos de Uso e Política de Privacidade (LGPD — o app guarda dado de treino e de saúde); monitoramento de erro em produção; **onboarding guiado só na primeira entrada** e **roteiro de uso sempre acessível em Ajustes**.
  - ❌ **Continua fora:** **planos pagos e tela de billing** — a abertura ao público NÃO é decisão de monetizar; monetização segue exigindo Scope Change próprio (mesma regra da linha do §11). **Landing page / tela de apresentação antes do login** — o login segue sendo a porta de entrada. **Domínio próprio** — adiado pelo dono; `lastro-pi.vercel.app` continua. Tudo o mais deste §5 (social, prescrição automática, wearable, calorias, app nativo em loja) segue **sem alteração**.
  - **Consequência que precisa estar escrita:** o lastro deixa de ser só "pessoas que o dono conhece". Dado de saúde de estranhos pede texto legal revisado por advogado antes de publicado (PU-06) — o texto no repositório é rascunho, não parecer jurídico.
