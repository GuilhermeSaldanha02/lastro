...
- **Armadilha nova, registrada lá:** as migrações `0027`–`0029` estão no banco com **versão de timestamp** (`20260914022051`, `20260914024607`, `20260914034625`), porque foram aplicadas fora do `db push`. O conteúdo está aplicado, mas `supabase db push` tentaria reaplicar — e o `0027` cria índice único. **Resolver com o dono antes de qualquer comando de Supabase.**
- **Em andamento:** nada.
- **Não commitado:** nada.
