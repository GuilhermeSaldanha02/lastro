...
- **Última sessão:** 2026-09-14 · agente: claude · branch `feat/icone-info-avisos`, tirada da `main` em `fd8fe44`. Sem merge. **O #259 (senha forte no cadastro) segue aberto em paralelo** e também mexe em `src/app/login/page.tsx`, em outro trecho.
