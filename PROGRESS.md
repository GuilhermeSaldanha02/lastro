...
> **➡️ Próximo passo: fechar o resto do gate visual da seção G de [`docs/BACKLOG-PROXIMA-FASE.md`](docs/BACKLOG-PROXIMA-FASE.md) — falta só G2 (contraste numérico) e os viewports exatos 360/390, mais o G5 no aparelho do dono.** A Leva 1 inteira (A1, B1+B2, A2+A3+A4) está implementada e **verificada a olho num navegador real** nesta sessão, na branch `chore/leva-1-higiene-visual`, ainda **sem PR aberto**.
