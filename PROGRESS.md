...
9. **Seleção de grupo muscular antes de iniciar o treino** (pedido do dono, 2026-08-07) — **construído e verificado em 2026-08-07, branch `feat/selecao-grupo-muscular`, PROPOSITALMENTE sem PR/merge ainda** (pedido explícito: "não suba o PR nem nada"). `SeletorGrupoMuscular` filtra o exercício mostrado no formulário pelo(s) grupo(s) escolhido(s); estado de sessão, não persistido (o app não prescreve programa, PRD §5). Detalhes e verificação em `DECISIONS.md` 2026-08-07.
