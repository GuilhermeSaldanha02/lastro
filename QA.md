...
| PE-03 | personal | `/ajustes/personal` na varredura de navegação (`j4`, usuário novo em 3 larguras) e na medição de contraste AA (`j5`, 7 temas) | **PASSOU** — não nesta máquina (o `.env.local` local não tem service-role), mas no CI do PR #226, contra o Supabase hospedado: `6 passed (4.5m)`, com a rota dentro da lista dos dois specs. Reprovaria em erro de console, 4xx/5xx, vazamento horizontal ou texto abaixo do piso AA | d81dadc | 2026-09-11 | run `34564944308` |
