...
| VS-03 | visual | Cabeçalho fixo do treino não sobrepõe conteúdo interativo em viewport curto (teclado aberto) | ALEGADO (causa raiz achada pela auditoria independente — `contentRect` vs `getBoundingClientRect` em `timer-topo.tsx` — corrigida; aguarda nova auditoria independente) | 7830329 | 2026-08-28 | qa/evidencias/VS-03/ |
