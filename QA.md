...
| PE-03 | personal | Contraste AA de `/ajustes/personal` nos 7 temas | **ALEGADO** — a rota entrou na `j5`, mas `j4`/`j5` **não rodaram nesta máquina** (usam o cliente admin e o `.env.local` local não tem service-role). Quem prova é o CI do PR | 943b6dc | 2026-09-11 | — |
