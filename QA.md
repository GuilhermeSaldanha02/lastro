...
| PE-04 | personal | `/personal` (a fila) na varredura de navegação (`j4`, três larguras) e na medição de contraste AA (`j5`, sete temas) | **COBERTO a partir de 2026-09-11** — o `beforeAll` das duas specs passou a montar um personal com aluno vinculado e um grupo abandonado semeado, então a fila é varrida COM alerta, não no estado vazio (medir moldura vazia seria o mesmo erro de antes, com outra cara). Resultado no CI abaixo | — | 2026-09-11 | — |
